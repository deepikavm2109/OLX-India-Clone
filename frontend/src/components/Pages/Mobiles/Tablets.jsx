...
const Tablets = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.mobileType) {
      newErrors.mobileType = "Mobile type is mandatory";
    }
  ...
  const mobileType = ["iPad","Samsung", "Other Tablets"];
  ...
  const handleSubmit = async(e) => {
    ...
    if (Object.keys(formErrors).length === 0) {
      ...
      uploadData.append("mobileType", formData.mobileType);
    ...
    <>
      ...
      <form className="form-title" onSubmit={handleSubmit}>
        ...
        <div className="form-div">
          ...
          {mobileType.map((type) => (
            <Button
              ...
              className={`form-input-button-type ${
                formData.mobileType === type ? "selected" : ""
              }`}
              onClick={() => {
                setFormData({ ...formData, mobileType : type});
          ...
          {errors.mobileType && <p className="error-message">{errors.mobileType}</p>}
        </div>
